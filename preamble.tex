...
\ifpdf
  ...
  urlcolor=black,%
  citecolor=black,%
  pdfauthor=Andrea~Schweer,%
  pdftitle=The~Roles~of~Context~and~Semantics~in~Augmenting~Autobiographical~Memory,%
  plainpages=false%
  ]{hyperref}
...
\hyphenation{Els-wei-ler groun-ded Ah-med Se-man-tic-LIFE Law-rence
  My-Life-Bits tem-po-ral se-quen-ces re-cor-ded auto-bio-gra-phi-cal
  epi-so-dic Rau-ber Pho-to-Mem-ory mul-ti-cri-te-rial
  Pa-tel-Schnei-der screen-shot screen-shots Feld-spar}
